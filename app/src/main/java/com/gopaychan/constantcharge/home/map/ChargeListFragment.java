...
import com.gopaychan.constantcharge.ViewHolder;
...
import com.gopaychan.constantcharge.charge.data.source.DataFactory;
...
import static com.gopaychan.constantcharge.charge.ChargeDetailActivity.TO_CHARGE_DETAIL_ACTIVITY_ARGS;
...
public class ChargeListFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_charge_list, container, false);
